...
import { Plus, Users, BarChart2, FileDown, Menu } from "lucide-react";
...
const ITEMS = [
  { label: "Nouvel élève",   icon: Plus,      to: "/fiche-eleve",     color: "#22d3ee" },
  { label: "Élèves",         icon: Users,     to: "/liste-eleves",    color: "#a3e635" },
  { label: "Stats",          icon: BarChart2, to: "/stats-annuelles", color: "#facc15" },
  { label: "Export annuel",  icon: FileDown,  to: null,               color: "#f472b6" },
];
...
export default function CircularMenuPro() {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Menu style={{ width: 36, height: 36, color: "rgba(255,255,255,0.9)" }} />
        </motion.div>
      </motion.div>
    </div>
  );
