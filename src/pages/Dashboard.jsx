...
export default function Dashboard() {
  ...
  return (
    <div style={{ fontFamily: "'Inter', sans-serif", background: '#F0F3F8', minHeight: '100vh', display: 'flex' }}>
        ...
        <div className="db-topbar" style={{ background: '#fff', borderBottom: '1px solid #D8E1EE', height: 54, padding: '0 26px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', position: 'sticky', top: 0, zIndex: 20 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexShrink: 0 }}>
            ...
            <div className="db-topbar-actions" style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
              <button onClick={() => setShowNotifs(!showNotifs)} style={{ position: 'relative', width: 36, height: 36, borderRadius: 9, background: '#F0F3F8', border: '1px solid #D8E1EE', display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer', fontSize: 16, padding: 0 }}>
                🔔
      ...
      {/* NOTIFICATIONS PANEL */}
      {showNotifs && (
        <div style={{ position: 'fixed', inset: 0, zIndex: 200 }} onClick={() => setShowNotifs(false)}>
          <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }}
            onClick={e => e.stopPropagation()}
            style={{ position: 'absolute', top: 54, right: 26, width: 320, maxHeight: 400, background: '#fff', border: '1px solid #D8E1EE', borderRadius: 12, boxShadow: '0 4px 20px rgba(0,0,0,.1)', overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
