    ...
    <div style={{ minHeight: '100vh', background: '#F0F3F8', fontFamily: 'Inter, sans-serif' }}>
      ...
      <div style={{ background: '#1A3353', padding: '20px 24px 18px' }}>
        <div style={{ maxWidth: 760, margin: '0 auto' }}>
          <button onClick={() => navigate('/mes-ecoles')} style={{ display: 'flex', alignItems: 'center', gap: 6, color: 'rgba(255,255,255,.6)', background: 'none', border: 'none', cursor: 'pointer', fontSize: 13, marginBottom: 12 }}>
            <ArrowLeft size={16} /> Mes écoles
          </button>
