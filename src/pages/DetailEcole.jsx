  ...
  return (
    <div className="min-h-screen bg-[#F8F9FB]">
                              ...
                              <td className="px-5 py-3 text-right">
                                {eleve.fiche_eleve_id ? (
                                  ...
                                  <Button size="sm" className="bg-blue-500 hover:bg-blue-600 text-white border-0"
                                    onClick={() => navigate('/fiche-eleve', { state: {
                                      prenom: eleve.prenom,
                                      nom: eleve.nom,
                                      classe: activeClasseData.nom,
                                      ecole: ecole.nom,
                                      date_naissance: eleve.date_naissance || '',
                                      eleve_rased_id: eleve.id,
                                    } })}>
                                    Créer fiche
                                  </Button>
                                )}
      ...
      {showDeleteConfirm && (
        <DeleteEcoleModal
          ecole={ecole}
          eleveCount={eleves.length}
          ficheCount={eleves.filter(e => e.fiche_eleve_id).length}
          onClose={() => setShowDeleteConfirm(false)}
          onDeleted={() => navigate('/mes-ecoles')}
        />
      )}
    </div>
  );
